...
class FraudPreventionParamsTests(Base):
    def setUp(self):
        super().setUp()
    ...
    def test_login_request_with_valid_params(self):
        ...
        response = self.client.post('/fraud_prevention', json=payload, headers=self.headers)
    ...
    def test_login_request_with_invalid_params(self):
        ...
        for key in payload:
            ...
            response = self.client.post('/fraud_prevention', json=custom_payload, headers=self.headers)
    ...
    def test_login_request_with_invalid_account(self):
    ...
    def test_login_request_without_access_token(self):
        ...
        response = self.client.post('/fraud_prevention', json=payload)
